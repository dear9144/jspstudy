...
public class PapagoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String clientId = "Zb5nhrzCXvkgR1xU8uql";
		String clientSecret = "UncXxikXrS";
		...
		String params = "source=" + source + "&target=" + target + "&text=" + URLEncoder.encode(text, "UTF-8"); //파라미터를 변수로 만들때 보통 params라고함
		
		// Papago API로 파라미터를 보내기 위해서 출력 스트림 생성을 하고 보내줘얗 ㅏㅁ
		...
		// StringByilder 결과를 client.html ajax 모습으로 보내기
